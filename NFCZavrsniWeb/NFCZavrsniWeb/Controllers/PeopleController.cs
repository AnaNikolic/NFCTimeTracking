...
namespace NFCZavrsniWeb.Controllers
{
    ...
    public class PeopleController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "OIB,FirstName,LastName,Address")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "OIB,FirstName,LastName,Address")] Person person)
        {
            if (ModelState.IsValid)
            {
